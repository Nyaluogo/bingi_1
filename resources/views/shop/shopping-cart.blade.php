...
@section('content')
    @if(Session::has('cart'))
                    ...
                    @foreach($products as $product)
                        <li class="list-group-item">
                          <div class="">
                            ...
                            {{--  <div class="btn-group">
                                <button class="btn btn-outline btn-xs dropdown-toggle" data-toggle="dropdown">Action <span class="caret"></span></button>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-6 col-md-offset-3 col-sm-offset-3">
               <a href = "{{ route('checkout') }}"  type="button" class="btn btn-outline">Checkout</a>
            </div>
        </div>
    @else
        <div class="row">
