            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('interest') }}">
                            {{ csrf_field() }}
                ...
                <div class="row mt">
                  <div class="col-lg-12">
                    <div class="form-panel">
                          <h4 class="mb"><i class="fa fa-angle-right"></i>What do you hope to achieve in Nyabingi?</h4>
                <div class="checkbox">
                  <label>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-4">
                                    ...
                                    <button class="btn btn-inverse" type="button">
                                        <a href="{{ route('home') }}" class="pull-right"><i class="icon wb-exit" aria-hidden="true"></i>Skip</a>
                                    </button>
                                </div>
                            </div>
                        </form>
