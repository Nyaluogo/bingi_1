...
<head>	
	...
	<meta name="keywords" content="Nyabingi, Free Bootstrap template, Landing page, Free responsive template, Free Template, App, Mobile">
	<meta name="author" content="Edwin Ochieng Nyaluogo Nyabingi">
	...
	<link rel="stylesheet" href="{{asset('landing_page/css/linea-icon.css')}}" />
	<link rel="stylesheet" href="{{asset('landing_page/css/fancy-buttons.css')}}" />
	...
	<link rel="stylesheet" href="{{asset('landing_page/css/jquery.vegas.css')}}" />
	<link rel="stylesheet" href="{{asset('landing_page/css/baraja.css')}}" />
	<link rel="stylesheet" href="{{asset('landing_page/css/jquery.bxslider.css')}}" />
	...
	<link rel="stylesheet" href="{{asset('landing_page/css/schemes/red.css')}}" disabled />
	<link rel="stylesheet" href="{{asset('landing_page/css/schemes/orange.css')}}" disabled />
	<link rel="stylesheet" id="scheme-source" href="{{asset('landing_page/css/schemes/gray.css')}}" />
	
	
	<link rel="stylesheet" href="{{asset('landing_page/css/color-switcher.css')}}" />
	...
	<div id="header" class="header-section">
				...
				<div id="topbar-hold" class="nav-hold container">
					<nav class="navbar" role="navigation">
						<div class="navbar-header">
							...
							<!--=== Site Name ===-->
							<a class="site-name navbar-brand" href="#"><span>Nyabingi</span></a>
						</div>
						...
						<div class="collapse navbar-collapse navbar-responsive-collapse">
							<ul class="nav navbar-nav navbar-right">
								...
								<li><a href="#section-feature">Shop</a></li>
		...
		<div id="section-home" class="home-section-wrap center">
			...
			<div class="container home">
				<div class="row">
					<h1 class="well-come">Nyabingi art gallery</h1>
					
					<div class="col-md-8 col-md-offset-2">
						<p class="intro-message"><strong>Nyabingi</strong> is an online art community that gives 
							artists a chance to showcase their art to the world and also share and learn together.</p>
						
						
						<div class="home-buttons">
                        @if (Route::has('login'))
                            @auth
                            <a href="{{ route('home') }}" class="fancy-button button-line button-white vertical">
                                Home
                                <span class="icon">
                            ...
                            @else
							<a href="{{ route('login') }}" class="fancy-button button-line button-white vertical">
								Login
								<span class="icon">
									<i class="fa fa-gear"></i>
								</span>
							</a>
							<a href="{{ route('register') }}" class="fancy-button button-line button-white zoom">
								Join
								<span class="icon">
			...
			<div class="row">
				...
				<div class="col-md-8 step-desc">
					...
					<div class="col-md-10 step-details">
							<h3 class="step-title color-scheme">Make your artwork more visible to the world</h3>
		...
		<div class="container step animated" data-animation="bounceInRight" data-animation-delay="700">
			<div class="row">
				...
				<div class="col-md-8 step-desc">
					...
					<div class="col-md-10 step-details">
							<h3 class="step-title color-scheme">Share your artwork with other artists</h3>
							<p class="step-description"><strong>Nyabingi</strong>,allows you to share your artwork with 
							different artist all over the world and get feed back to help you improve
							</p>
			...
			<div class="row">
				<div class="col-lg-12">
					<h4 class="footer-title"><!-- Footer Title -->
						<a class="site-name" href="#"><span>Nyabingi</span>gallery</a>
					</h4>
					
					<!-- Social Links -->
					<div class="social-icons">
						<ul>
							<li><a href="https://www.facebook.com/pages/Themegret/337546306439029"><i class="fa fa-facebook-square"></i></a></li>
					...
					<p class="copyright">All right reserved &copy; 2018</p>
				</div>
			</div>
		</div>
	</div>
...
<!--==== Js files ====-->
<!--==== Essential files ====-->
<script type="text/javascript" src="{{asset('landing_page/js/jquery-1.11.1.min.js')}}"></script>
<script type="text/javascript" src="{{asset('landing_page/js/bootstrap.min.js')}}"></script>
<script type="text/javascript" src="{{asset('landing_page/js/bootstrapValidator.min.js')}}"></script>
<script type="text/javascript" src="{{asset('landing_page/js/modernizr.js')}}"></script>
<script type="text/javascript" src="{{asset('landing_page/js/jquery.easing.1.3.js')}}"></script>

<!--==== Slider and Card style plugin ====-->
<script type="text/javascript" src="{{asset('landing_page/js/jquery.baraja.js')}}"></script>
<script type="text/javascript" src="{{asset('landing_page/js/jquery.vegas.min.js')}}"></script>
<script type="text/javascript" src="{{asset('landing_page/js/jquery.bxslider.min.js')}}"></script>

<!--==== MailChimp Widget plugin ====-->
<script type="text/javascript" src="{{asset('landing_page/js/jquery.ajaxchimp.min.js')}}"></script>

<!--==== Scroll and navigation plugins ====-->
<script type="text/javascript" src="{{asset('landing_page/js/jquery.nicescroll.min.js')}}"></script>
<script type="text/javascript" src="{{asset('landing_page/js/jquery.nav.js')}}"></script>
<script type="text/javascript" src="{{asset('landing_page/js/jquery.appear.js')}}"></script>
<script type="text/javascript" src="{{asset('landing_page/js/jquery.fitvids.js')}}"></script>

<!--==== Custom Script files ====-->
<script type="text/javascript" src="{{asset('landing_page/js/custom.js')}}"></script>

<script type="text/javascript" src="{{asset('landing_page/js/color-switcher.js')}}"></script>
{{--  <script>
...
$(window).ready(function() {
	...
	$.vegas('slideshow', {
	  backgrounds:[
		{ src:'{{asset('landing_page/images/bg-slider/bg-4.jpg')}}', fade:1000 },
		{ src:'{{asset('landing_page/images/bg-slider/bg-5.jpg')}}', fade:1000 },
		{ src:'{{asset('landing_page/images/bg-slider/bg-6.jpg')}}', fade:1000 }
	  ]
	})();
});
</script>
