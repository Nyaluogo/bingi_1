...
@section('content')
  ...
  <div class="page">
        <div class="page-header">
          <h1 class="page-title">Complete your shipping details</h1>
                  ...
                  <!-- Wizard Content -->
                    ...
                    <div class="wizard-content">
                      <div class="wizard-pane active" id="exampleAccountOne" role="tabpanel">
                            <form id="exampleFormContainer" action="{{ route('portfolio.shipping') }}" role="form" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <img class="img-fluid" src="{{$artwork->path}}" max-width= "100%" height= "auto">
                                <br>

                                <div class="form-group row has-success">
                                    <label class="col-md-3 form-control-label">Enter the shipping weight of your artwork</label>
                                    <div class="col-md-9">
                                        <input type="number" class="form-control is-valid" name="weight" placeholder="weight" data-fv-field="type_digits">
                                        <span>NB: All weights should be in Kgs(Kilograms)</span>
                            ...
                            <input type="hidden" value="{{$artwork->id}}" name="artwork_id">
                                ...
                                <p><strong>Tell us where your artwork will be picked</strong></p>
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="inputBasicPassword">Address 1</label>
                                    <input type="text" class="form-control" id="inputBasicPassword" name="address_1"
                                        placeholder="Address 1" value="{{Auth::user()->profile->address_1}}" autocomplete="off" />
                                </div>
                                
                                <div class="form-group">
                                    <label class="form-control-label" for="inputBasicPassword">Address 2</label>
                                    <input type="text" class="form-control" id="inputBasicPassword" name="address_2"
                                        placeholder="Address 2" value="{{Auth::user()->profile->address_2}}" autocomplete="off" />
                                </div>

                                <div class="form-group">
                                    <label class="form-control-label" for="inputBasicPassword">Region</label>
                                    <input type="text" class="form-control" id="inputBasicPassword" name="region"
                                        placeholder="Address 2" value="{{Auth::user()->profile->region}}" autocomplete="off" />
                                </div>
                                ...
                                <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                                    ...
                                    <div class="form-group{{ $errors->has('country') ? ' has-error' : '' }}">
                                        ...
                                        <select name="country" id="country_list" placeholder=""
                                                value="{{Auth::user()->profile->country}}" class="form-control">
                                            <option value="{{Auth::user()->profile->country}}">{{Auth::user()->profile->country}}</option>
                                ...
                                <div class="form-group">
                                    <label class="form-control-label" for="inputBasicPassword">Postal code</label>
                                    <input type="text" class="form-control" id="inputBasicPassword" name="postal_code"
                                        placeholder="Address 2" value="{{Auth::user()->profile->postal_code}}" autocomplete="off" />
                                </div>
