...
@section('content')
  ...
  <div class="page">
        <div class="page-header">
          <h1 class="page-title">Update your artwork details</h1>
                  ...
                  <!-- Wizard Content -->
                    ...
                    <div class="wizard-content">
                      <div class="wizard-pane active" id="exampleAccountOne" role="tabpanel">
                            <form id="exampleFormContainer" action="{{ route('portfolio.update') }}" role="form" method="POST" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                {{--  <div class="example">
                                    <label class="form-control-label" for="inputBasicAvatar">Upload artwork</label>
                                    <input type="file" id="input-file-now-custom-1" data-plugin="dropify" data-default-file="../../global/photos/view-7-960x640.jpg"
                                    data-height="250" data-width="250" data-max-file-size="4M" name="image_file" required/>
                                </div>  --}}
                                <input type = "hidden" name = "post_id" value = " {{ $artwork->id }} ">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="description" id="dscription" cols="30" rows="10" class="form-control" >{{ old('description') }}</textarea>
                                </div>
                                ...
                                <div class="example">
                                      ...
                                      <div class = "form-group">
                                            <label class="form-control-label" for="comment_options">Allow Comments</label>
                                            <li class="list-inline-item mr-25 mb-25">
